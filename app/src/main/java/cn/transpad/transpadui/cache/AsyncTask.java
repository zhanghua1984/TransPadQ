 ...
 * {@link Handler} and does not constitute a generic threading
        ...
        mFuture = new FutureTask<Result>(mWorker) {
            ...
            protected void done() {
                try {
                    ...
                    android.util.Log.w(LOG_TAG, ie);
                } catch (ExecutionException ee) {
                    android.util.Log.w(LOG_TAG, ee);
                } catch (CancellationException ce) {
                    android.util.Log.w(LOG_TAG, ce);
