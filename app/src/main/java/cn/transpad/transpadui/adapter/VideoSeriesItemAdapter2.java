 ...
 */
public class VideoSeriesItemAdapter2 extends BaseAdapter {
    private Context mContext;
    private List<DramaRst.Cnt> cntLists;

    public VideoSeriesItemAdapter2(Context context,List<DramaRst.Cnt> cntList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            convertView = LayoutInflater.from(mContext).inflate(R.layout.video_selected_content_item, null);
