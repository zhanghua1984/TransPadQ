...
import cn.transpad.transpadui.adapter.LiteVideoListAdapter;
 ...
 */
public class LiteVideoPlayFragment extends BaseFragment {
    ...
    LiteVideoListAdapter videoListAdapter;
...
//    LinearLayout video_choose_right;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        videoListAdapter = new LiteVideoListAdapter(getActivity(), gv_menu);
