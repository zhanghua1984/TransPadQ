...
public class LiteHomeActivity extends Activity {

    private static final String TAG = "LiteHomeActivity";
...
//        }
    ...
    private void showMainFragment() {
        Fragment fragment = new MainFragmentLite();
        if (fragment != null) {
    ...
    public void onEventMainThread(Message message) {
        switch (message.what) {
            ...
            case StorageModule.MSG_DOWNLOAD_CACHE_SUCCESS://应用下载完成
                ...
                if (offlineCache != null && offlineCache.getCacheDownloadType() == OfflineCache.CACHE_FROM_PAGE_UPGRADE){
