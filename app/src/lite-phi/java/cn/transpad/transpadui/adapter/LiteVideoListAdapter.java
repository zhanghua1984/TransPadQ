...
import cn.transpad.transpadui.player.activity.LiteVideoPlayActivity;
import cn.transpad.transpadui.util.L;

/**
 * Created by wangshaochun on 2015/4/17.
 */
public class LiteVideoListAdapter extends BaseAdapter {
    private final static String TAG = LiteVideoListAdapter.class.getSimpleName();
    ...
    public LiteVideoListAdapter(Context context, GridView gridView) {
        ...
        viewHolder.rl_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isPlayMode) {//根据播放模式进行不同点击效果的判断
                    ...
                    Intent intent = new Intent(mContext, LiteVideoPlayActivity.class);
                    intent.putParcelableArrayListExtra("playlist", multipleVideoList);
                    ...
                    LiteVideoListAdapter.this.notifyDataSetChanged();
                } else {
